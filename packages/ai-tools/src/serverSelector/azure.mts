	...
	public override readonly servers = new Set<Server>([
		{
			...
			privacyRegion: PrivacyRegion.Australian_Privacy_Principles,
		...
		},
		{
			...
			privacyRegion: PrivacyRegion.Brazil_General_Data_protection_Law,
		...
		},
		{
			...
			privacyRegion: PrivacyRegion.Canada_Personal_Information_Protection_and_Electronic_Documents_Act,
		...
		},
		{
			...
			privacyRegion: PrivacyRegion.General_Data_Protection_Regulation,
			languageModelAvailability: ['gpt-35-turbo', 'gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini'],
			imageModelAvailability: [],
		...
		},
		{
			...
			privacyRegion: PrivacyRegion.Japan_Act_on_the_Protection_of_Personal_Information,
			languageModelAvailability: ['gpt-35-turbo', 'gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini'],
			imageModelAvailability: [],
			textEmbeddingModelAvailability: ['text-embedding-3-large', 'text-embedding-3-small'],
		},
		{
			...
			privacyRegion: PrivacyRegion.Korean_Personal_Information_Protection_Act,
			languageModelAvailability: ['gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini'],
			imageModelAvailability: [],
			textEmbeddingModelAvailability: [],
		},
		...
		},
		{
			...
			privacyRegion: PrivacyRegion.Norwegian_Personal_Data_Act,
			languageModelAvailability: ['gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini'],
			imageModelAvailability: [],
			textEmbeddingModelAvailability: ['text-embedding-3-large'],
		},
		...
		},
		{
			...
			privacyRegion: PrivacyRegion.SouthAfrica_Protection_Personal_Information_Act,
			languageModelAvailability: ['gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini'],
			imageModelAvailability: [],
			textEmbeddingModelAvailability: [],
		},
		...
		},
		{
			...
			privacyRegion: PrivacyRegion.Indian_Personal_Protection,
			languageModelAvailability: ['gpt-35-turbo', 'gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini'],
			imageModelAvailability: [],
			textEmbeddingModelAvailability: ['text-embedding-3-large'],
		},
		...
		},
		{
			...
			privacyRegion: PrivacyRegion.Swiss_Federal_Act_on_Data_Protection,
			languageModelAvailability: [],
			imageModelAvailability: [],
			textEmbeddingModelAvailability: [],
		},
		...
		},
		{
			...
			privacyRegion: PrivacyRegion.UK_General_Data_Protection_Regulation,
			languageModelAvailability: ['gpt-35-turbo', 'gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini'],
			imageModelAvailability: [],
			textEmbeddingModelAvailability: ['text-embedding-3-large'],
		},
