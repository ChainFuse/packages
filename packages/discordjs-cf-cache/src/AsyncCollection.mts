 ...
 * @internal
 */
export interface AsyncCollectionConstructor {
	new (): AsyncCollection<unknown, unknown>;
	new <Key, Value>(entries?: readonly (readonly [Key, Value])[] | null): AsyncCollection<Key, Value>;
	new <Key, Value>(iterable: Iterable<readonly [Key, Value]>): AsyncCollection<Key, Value>;
	readonly prototype: AsyncCollection<unknown, unknown>;
	readonly [Symbol.species]: AsyncCollectionConstructor;
}
 ...
 * @internal
 */
export interface AsyncCollection<Key, Value> extends Map<Key, Value> {
	constructor: AsyncCollectionConstructor;
}
...
export class AsyncCollection<Key, Value> extends Map<Key, Value> {
	...
	public random(amount?: number): Value | Value[] | undefined {
		...
		return Array.from({ length: Math.min(amount, arr.length) }, (): Value => arr.splice(Math.floor(Math.random() * arr.length), 1)[0]!);
	}
	...
	public randomKey(amount?: number): Key | Key[] | undefined {
		...
		if (amount === undefined) return arr[Math.floor(Math.random() * arr.length)];
		if (!arr.length || !amount) return [];
		return Array.from({ length: Math.min(amount, arr.length) }, (): Key => arr.splice(Math.floor(Math.random() * arr.length), 1)[0]!);
	}
	 ...
	 * ```
	 */
	public filter<NewKey extends Key>(fn: (value: Value, key: Key, collection: this) => key is NewKey): AsyncCollection<NewKey, Value>;
	public filter<NewValue extends Value>(fn: (value: Value, key: Key, collection: this) => value is NewValue): AsyncCollection<Key, NewValue>;
	public filter(fn: (value: Value, key: Key, collection: this) => unknown): AsyncCollection<Key, Value>;
	public filter<This, NewKey extends Key>(fn: (this: This, value: Value, key: Key, collection: this) => key is NewKey, thisArg: This): AsyncCollection<NewKey, Value>;
	public filter<This, NewValue extends Value>(fn: (this: This, value: Value, key: Key, collection: this) => value is NewValue, thisArg: This): AsyncCollection<Key, NewValue>;
	public filter<This>(fn: (this: This, value: Value, key: Key, collection: this) => unknown, thisArg: This): AsyncCollection<Key, Value>;
	public filter(fn: (value: Value, key: Key, collection: this) => unknown, thisArg?: unknown): AsyncCollection<Key, Value> {
		if (typeof fn !== 'function') throw new TypeError(`${fn} is not a function`);
		if (thisArg !== undefined) fn = fn.bind(thisArg);
	 ...
	 * ```
	 */
	public partition<NewKey extends Key>(fn: (value: Value, key: Key, collection: this) => key is NewKey): [AsyncCollection<NewKey, Value>, AsyncCollection<Exclude<Key, NewKey>, Value>];
	public partition<NewValue extends Value>(fn: (value: Value, key: Key, collection: this) => value is NewValue): [AsyncCollection<Key, NewValue>, AsyncCollection<Key, Exclude<Value, NewValue>>];
	public partition(fn: (value: Value, key: Key, collection: this) => unknown): [AsyncCollection<Key, Value>, AsyncCollection<Key, Value>];
	public partition<This, NewKey extends Key>(fn: (this: This, value: Value, key: Key, collection: this) => key is NewKey, thisArg: This): [AsyncCollection<NewKey, Value>, AsyncCollection<Exclude<Key, NewKey>, Value>];
	public partition<This, NewValue extends Value>(fn: (this: This, value: Value, key: Key, collection: this) => value is NewValue, thisArg: This): [AsyncCollection<Key, NewValue>, AsyncCollection<Key, Exclude<Value, NewValue>>];
	public partition<This>(fn: (this: This, value: Value, key: Key, collection: this) => unknown, thisArg: This): [AsyncCollection<Key, Value>, AsyncCollection<Key, Value>];
	public partition(fn: (value: Value, key: Key, collection: this) => unknown, thisArg?: unknown): [AsyncCollection<Key, Value>, AsyncCollection<Key, Value>] {
		if (typeof fn !== 'function') throw new TypeError(`${fn} is not a function`);
		if (thisArg !== undefined) fn = fn.bind(thisArg);
		const results: [AsyncCollection<Key, Value>, AsyncCollection<Key, Value>] = [new this.constructor[Symbol.species]<Key, Value>(), new this.constructor[Symbol.species]<Key, Value>()];
		for (const [key, val] of this) {
			if (fn(val, key, this)) {
	 ...
	 * ```
	 */
	public flatMap<NewValue>(fn: (value: Value, key: Key, collection: this) => AsyncCollection<Key, NewValue>): AsyncCollection<Key, NewValue>;
	public flatMap<NewValue, This>(fn: (this: This, value: Value, key: Key, collection: this) => AsyncCollection<Key, NewValue>, thisArg: This): AsyncCollection<Key, NewValue>;
	public flatMap<NewValue>(fn: (value: Value, key: Key, collection: this) => AsyncCollection<Key, NewValue>, thisArg?: unknown): AsyncCollection<Key, NewValue> {
	...
	public map<This, NewValue>(fn: (this: This, value: Value, key: Key, collection: this) => NewValue, thisArg: This): NewValue[];
	 ...
	 * ```
	 */
	public mapValues<NewValue>(fn: (value: Value, key: Key, collection: this) => NewValue): AsyncCollection<Key, NewValue>;
	public mapValues<This, NewValue>(fn: (this: This, value: Value, key: Key, collection: this) => NewValue, thisArg: This): AsyncCollection<Key, NewValue>;
	public mapValues<NewValue>(fn: (value: Value, key: Key, collection: this) => NewValue, thisArg?: unknown): AsyncCollection<Key, NewValue> {
		if (typeof fn !== 'function') throw new TypeError(`${fn} is not a function`);
		if (thisArg !== undefined) fn = fn.bind(thisArg);
	 ...
	 * ```
	 */
	public every<NewKey extends Key>(fn: (value: Value, key: Key, collection: this) => key is NewKey): this is AsyncCollection<NewKey, Value>;
	public every<NewValue extends Value>(fn: (value: Value, key: Key, collection: this) => value is NewValue): this is AsyncCollection<Key, NewValue>;
	public every(fn: (value: Value, key: Key, collection: this) => unknown): boolean;
	public every<This, NewKey extends Key>(fn: (this: This, value: Value, key: Key, collection: this) => key is NewKey, thisArg: This): this is AsyncCollection<NewKey, Value>;
	public every<This, NewValue extends Value>(fn: (this: This, value: Value, key: Key, collection: this) => value is NewValue, thisArg: This): this is AsyncCollection<Key, NewValue>;
	 ...
	 * ```
	 */
	public reduce(fn: (accumulator: Value, value: Value, key: Key, collection: this) => Value, initialValue?: Value): Value;
	public reduce<InitialValue>(fn: (accumulator: InitialValue, value: Value, key: Key, collection: this) => InitialValue, initialValue: InitialValue): InitialValue;
	public reduce<InitialValue>(fn: (accumulator: InitialValue, value: Value, key: Key, collection: this) => InitialValue, initialValue?: InitialValue): InitialValue {
		if (typeof fn !== 'function') throw new TypeError(`${fn} is not a function`);
	 ...
	 * @param initialValue - Starting value for the accumulator
	 */
	public reduceRight(fn: (accumulator: Value, value: Value, key: Key, collection: this) => Value, initialValue?: Value): Value;
	public reduceRight<InitialValue>(fn: (accumulator: InitialValue, value: Value, key: Key, collection: this) => InitialValue, initialValue: InitialValue): InitialValue;
	public reduceRight<InitialValue>(fn: (accumulator: InitialValue, value: Value, key: Key, collection: this) => InitialValue, initialValue?: InitialValue): InitialValue {
		if (typeof fn !== 'function') throw new TypeError(`${fn} is not a function`);
		const entries = [...this.entries()];
		let accumulator!: InitialValue;
	 ...
	 * ```
	 */
	public clone(): AsyncCollection<Key, Value> {
	 ...
	 * ```
	 */
	public sort(compareFunction: Comparator<Key, Value> = AsyncCollection.defaultSort) {
		const entries = [...this.entries()];
	 ...
	 * ```
	 */
	public toSorted(compareFunction: Comparator<Key, Value> = AsyncCollection.defaultSort) {
	 ...
	 * ```
	 */
	public static combineEntries<Key, Value>(entries: Iterable<[Key, Value]>, combine: (firstValue: Value, secondValue: Value, key: Key) => Value): AsyncCollection<Key, Value> {
		const coll = new AsyncCollection<Key, Value>();
		for (const [key, value] of entries) {
			if (coll.has(key)) {
